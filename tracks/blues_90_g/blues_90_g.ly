...
% --- HARMONY (G7 blues: I7-IV7-V7) ---
chordI  = { <g b d f!>2 <g b d f!>2 | }
chordIV = { <c e g bes>2 <c e g bes>2 | }
chordV  = { <d fis a c>2 <d fis a c>2 | }
...
% --- BASS ---
bassI  = \relative c { g,4 d' g, d' | }
bassIV = \relative c { c,4 g' c, g' | }
bassV  = \relative c { d,4 a' d, a' | }
